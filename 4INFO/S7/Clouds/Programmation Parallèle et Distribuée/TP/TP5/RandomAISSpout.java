...
public class RandomAISSpout extends BaseRichSpout {
    ...
    public void declareOutputFields(OutputFieldsDeclarer declarer) {
        declarer.declare(new Fields("id", "speed", "destination"));
    }
    ...
    public void nextTuple() {
        Utils.sleep(100);
        collector.emit(new Values(rand.nextInt(10)+1, rand.nextDouble()*5, Destination.randomDestination()), ++msgId);
    }
