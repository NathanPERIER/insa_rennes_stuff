...
main (int argc, char *argv[])
{
  ...
  RngSeedManager::SetSeed(RAND_SEED);
...
//  phy.Set("CcaMode1Threshold", DoubleValue(-99));
  ...
  wifi.SetRemoteStationManager ("ns3::ConstantRateWifiManager", "DataMode",StringValue ("DsssRate" PHY_RATE "Mbps"), "ControlMode",StringValue ("DsssRate" PHY_RATE "Mbps"));
 ...
 /////////////////////////////Deployment///////////////////////////// 
      ...
      positionAllocAP->Add (Vector (5.0, 8.66, 1.0));
...
/////////////////////////////Application part///////////////////////////// 
  ...
  std::string rate = "20.0Mbps";
   ...
   ApplicationContainer onOffApp;
    ...
    onOffHelper.SetAttribute("DataRate", DataRateValue(DataRate(rate))); //Traffic Bit Rate
    onOffHelper.SetAttribute("PacketSize", UintegerValue(1000));
    onOffApp.Add(onOffHelper.Install(stas.Get(0)));


    OnOffHelper onOffHelper2("ns3::UdpSocketFactory", InetSocketAddress(wifiInterfaces.GetAddress (3), dlPort));
    ...
    onOffHelper2.SetAttribute("DataRate", DataRateValue(DataRate(rate))); //Traffic Bit Rate
