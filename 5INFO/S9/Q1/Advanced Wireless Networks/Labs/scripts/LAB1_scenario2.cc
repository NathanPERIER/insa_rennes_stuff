...
/////////////////////////////Devices///////////////////////////// 
 ...
 /////////////////////////////Deployment///////////////////////////// 
      ...
      positionAlloc->Add (Vector (37.42, 0.0, 1.0)); //251.1 for two way ground propagation model
...
//Ptr<Cost231PropagationLossModel> propmode = wifiStaNodes.Get(0)->GetObject<Cost231PropagationLossModel> ();
//double pos;
