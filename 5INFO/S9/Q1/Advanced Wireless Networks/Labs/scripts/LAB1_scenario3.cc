...
/////////////////////////////Devices///////////////////////////// 
 ...
 /////////////////////////////Deployment///////////////////////////// 
      ...
      positionAlloc->Add (Vector (36.5, 0.0, 1.0)); //251.1 for two way ground propagation model
...
//Ptr<FriisPropagationLossModel> propmode = wifiStaNodes.Get(0)->GetObject<FriisPropagationLossModel> ();
//double pos;
